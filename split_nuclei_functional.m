...
nuc_peaks=imextendedmax(ndtf,peak_est_thr*max(ndtf(:))); %% for loop with diff values; compare outputs; bwlabel - value to optimize against for num of nuclei
...
% not overlapped nucs
small_nucs = bwareafilt(nucleus_mask,[0 250]);
multiple_nucs = multiple_nucs - small_nucs;
...
final_nuclei=segmented_nuclei|bwconvhull(single_nucs,'objects');
